!function($, wysi) {
    ...
    var tpl = {
        ...
        "lists": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                ...
                "<a class='btn" + size + "' data-wysihtml5-command='justifyCenter' title='" + locale.lists.justifyCenter + "' tabindex='-1'><i class='icon-align-center'></i></a>" +
                "</div>" +
            "</li>";
        },
        ...
        "image": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
              "<div id='full-width' class='bootstrap-wysihtml5-insert-image-modal modal container hide fade'>" +
                "<div class='modal-header'>" +
                  "<a class='close' data-dismiss='modal'></a>" +
                  "<h3>Chèn ảnh</h3>" +
                "</div>" +
                "<div class='images-data modal-body'>" +
...
//                "wysiwyg-text-align-center": 1
        ...
        stylesheets: ["./wysiwyg-color1.css"], // (path_to_project/lib/css/wysiwyg-color.css)
        locale: "en"
    };
...
//    $.post('/food/admin/media/index',{template: 'admin/media/media', terminal: true},function(rs){
//        $('.images-data').append(rs);
//    });
