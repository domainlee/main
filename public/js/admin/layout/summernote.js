...
//            alert('dialog');
        ...
        var $imageInput = $dialog.find('.note-image-input'),
          ...
          function loadImage(){
              var p = $.post('/admin/media/index',{template: '/admin/media/media', terminal: true, order: 'DESC'},function(rs){
          ...
          $('#insertText').unbind().click(function(){
              if($('#listImage li.active').length > 0){
                  var li = $('.listImage li.active');
                  li.each(function(){
                      $('#textarea_full').summernote('editor.insertImage', $(this).find('img').attr('src'));
                  });
              }
...
//                          }
        ...
        $imageDialog.one('shown.bs.modal', function () {
          // Cloning imageInput to clear element domainlee.
  ...
  var Renderer = function () {
    ...
    var tplDialog = function (className, title, body, footer) {
      ...
      var dialogUpload = function(className, title, body, footer){
          return '<div id="TaskListDialog" class="modal hide in" tabindex="-1" role="dialog" aria-labelledby="windowTitleLabel">'+
              '<div class="modal-header">'+
              '<h3>Hình ảnh</h3>'+
              '</div>'+
...
//              imageLimitation +
//              '</div>' +
//              '<div class="form-group" style="overflow:auto;margin: 10px 0 0 0;">' +
//                  '<label>Đường dẫn</label>' +
//                  '<input class="note-image-url form-control col-md-12" type="text" />' +
//              '</div>';
            var body = '<ul class="nav nav-tabs">'+
                '<li class="active"><a href="" data-toggle="tab">Danh sách</a></li>'+
                '<li><input type="file" name="imagemulti[]" class="m-wrap btn-block imagemulti1" id="imagemulti1" multiple="multiple"></li>'+
                '</ul>'+
                '<div class="tab-content">'+
                '<div class=" " id="">'+
                '<div id="dataImage" class="" style="overflow-y: scroll;height: 300px">'+
...
//                '</div>'+
            ...
            var footer = '<button href="#" id="insertText" class="btn btn-primary" >Chèn ảnh</button>';
